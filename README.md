...
* `02_how-medgan-binary-works.ipynb`: [Understanding how medGAN works (with binary variables)](https://github.com/sylvaincom/medgan-tips/blob/master/02_how-medgan-binary-works.ipynb). In this notebook, I provide a few code cells and explanations that can help better understand and run medGAN on binary variables.
* `03_how-medgan-count-works.ipynb`: [Understanding how medGAN works (with count variables)](https://github.com/sylvaincom/medgan-tips/blob/master/03_how-medgan-count-works.ipynb). In this notebook, I provide a few code cells and explanations that can help better understand and run medGAN on count variables.
